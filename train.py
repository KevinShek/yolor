...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov4-tiny-640-heridal.cfg', help='model.yaml path')
    ...
    if opt.resume:  # resume an interrupted run
        ...
        if opt.evolve:
            ...
            evolve = False
        opt.save_dir = increment_path(Path(opt.project) / opt.name, exist_ok=opt.exist_ok | evolve)  # increment run
