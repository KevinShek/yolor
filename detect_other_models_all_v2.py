...
>>>>>>> 13864ca8a79535ab21616a3cd7e422f1214bec06
    ...
    with open(save_dir / f'operation_{date_time.day}_{date_time.month}_{date_time.year}_{date_time.hour}_{date_time.minute}_{date_time.second}.txt', 'a') as f:
        f.write(('Date: %s/%s/%s Time: %s/%s/%s') % (date_time.day, date_time.month, date_time.year, date_time.hour, date_time.minute, date_time.second) + '\n\n')
...
<<<<<<< HEAD
=======
<<<<<<<< HEAD:detect_other_models_all.py
        if khadas:
            if webcam:
                img = img
            else:
...
<<<<<<< HEAD
=======
>>>>>>>> 13864ca8a79535ab21616a3cd7e422f1214bec06:detect_other_models_all_v2.py
>>>>>>> 13864ca8a79535ab21616a3cd7e422f1214bec06
        elif saved_model:
            img = img.numpy()
